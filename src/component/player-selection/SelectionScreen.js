...
const characters = [
  {
    ...
    boxShadow: "rgba(212, 124, 24, 0.3) 0px 19px 38px, rgba(206, 104, 21, 0.22) 0px 15px 12px",
    opacity: "0.3",
  },
  {
    imgSrc: sakuraPic,
    ...
    boxShadow: "rgba(211, 102, 233, 0.3) 0px 19px 38px, rgba(213, 71, 241, 0.22) 0px 15px 12px",
    opacity: "0.3",
  },
  {
    imgSrc: leePic,
    ...
    boxShadow: "rgba(65, 121, 43, 0.3) 0px 19px 38px, rgba(71, 241, 99, 0.22) 0px 15px 12px",
    opacity: "0.3",
  },
  {
    imgSrc: blondePic,
    ...
    border: "3px solid violet",
    boxShadow: "rgba(143, 82, 223, 0.3) 0px 19px 38px, rgba(176, 94, 223, 0.22) 0px 15px 12px",
    opacity: "0.3",
  },
];
...
function SelectionScreen() {
  return (
    ...
    <Row><h1 className="chooseCharText">CHOOSE YOUR CHARACTER</h1></Row> 
      <Row>
